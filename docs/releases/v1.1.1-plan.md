...
- [x] GitHub Release workflow 触发：`Publish Release` run `27846289271` 成功；Release URL `https://github.com/winloud/Reimbursement-Tool/releases/tag/v1.1.1`；Release notes 已从 `CHANGELOG.md` 的 v1.1.1 段落带出；资产包含 `reimbursement-tool-v1.1.1-20260620.zip` 和 `opencv-wechat-runtime-opencv-4.10.0.84-win_amd64.zip`
